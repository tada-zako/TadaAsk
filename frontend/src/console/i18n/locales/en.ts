export const en = {
  ...
  chat: {
    ...
    composer: {
      ...
      selectSources: "Select sources for RAG",
      cancelAria: "Stop generation",
      sendAria: "Send message",
    },
    context: {
      configure: "Configure RAG sources",
      configured: "RAG context · {count} sources",
  ...
  sources: {
    ...
    page: {
      ...
      description:
        "Create source containers, review visibility, and open each source item workspace when upload, crawl, or indexing work is needed.",
    },
    common: {
      actions: {
        cancel: "Cancel",
      ...
      fields: {
        ...
        maxPages: "Max pages",
        name: "Name",
        publicForVisitorRag: "Public for visitor RAG",
        requestDelayMs: "Request delay ms",
        rootUrl: "Root URL",
        ...
        urls: "URLs",
        visibility: "Visibility",
        webCrawlConfig: "Web crawl config",
      },
    ...
    create: {
      title: "Create source",
      openAria: "Create source",
      localFileAria: "Choose local file source type",
      localFileHelp: "Upload files from the items page.",
      webCrawlAria: "Choose web crawl source type",
      webCrawlHelp: "Configure crawl rules before sync.",
      namePlaceholder: "Product docs PDF",
      publicHelp: "Keep off while importing or reviewing source items.",
      visitorReadyHelp:
        "Visitor RAG still requires at least one completed source item.",
      crawlHelp: "Crawled pages are materialized from the items workspace.",
      cancelAria: "Cancel source creation",
      confirmAria: "Confirm source creation",
    },
    list: {
      searchPlaceholder: "Search sources",
      filterAria: "Filter sources by type",
      ...
      openItemsAria: "Open {name} source items",
      items: "Items",
    },
    workspace: {
      webKicker: "Web crawl source",
      localKicker: "Local file source",
      fallbackKicker: "Source items",
    ...
    toolbar: {
      searchPages: "Search crawled pages",
      searchItems: "Search source items",
      syncCrawl: "Sync crawl",
      uploadFiles: "Upload files",
      openSettingsAria: "Open source settings",
    },
    itemsTable: {
      files: "files",
      pages: "pages",
      selected: "Selected: {count} {entity}",
      batchHelp: "Batch operations apply to checked rows.",
      indexSelectedAria: "Index selected {entity}",
      deleteSelectedAria: "Delete selected {entity}",
      selectAllAria: "Select all {entity}",
      ...
      loading: "Loading source items...",
      empty: "No source items found.",
      ready: "Ready",
      notIndexed: "Not indexed",
      actionAria: "{action} {title}",
      renameTitle: "Rename source item",
      titleField: "Title",
      cancelRenameAria: "Cancel source item rename",
      confirmRenameAria: "Confirm source item rename",
      deleteTitle: "Delete selected item?",
      deleteDescription:
        "This removes the source item and cleans up related file/vector data when supported by the backend.",
    },
    settings: {
      openAria: "Open {name} source settings",
      localTitle: "Local file settings",
      webTitle: "Web crawl settings",
      profileTitle: "Source profile",
      profileHelp:
        "Edit the container name and visitor visibility for this source.",
      localVisibilityHelp:
        "Disable while uploading or reviewing imported files.",
      webVisibilityHelp: "Keep enabled only after crawl results are reviewed.",
      ...
      deleteDescription:
        "This removes the source container and its related source items. Processing sources may be rejected by the backend.",
      saveAria: "Save source settings",
    },
    service: {
      errors: {
